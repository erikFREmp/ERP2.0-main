        ...
        <form id="documentosForm1" name="documentosForm1" class="bloque1">
           ...
           <div class="">
                ...
                <select name="tipo" id="tipo">
                    <option value="1">Pedido compra</option>
                    <option value="3">Albarán compra</option>
                    <option value="6">Factura compra</option>
                    <option value="8">Presupuesto compra</option>
                </select>
           </div>
            <div class="happy">
            ...
            <div class="margin1">
                <p class="color-white-1">Identificador Almacen</p>
...
document.getElementById("botonDoc").addEventListener("click", function() {
    ...
    <div id="contenedorDocumentos" class="contenedor2">  
        <?php require_once "controllers/documentos1Controller.php"; ?>
