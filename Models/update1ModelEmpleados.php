<?php
    ...
    class Datos
    {
        ...
        public function setDataPreparedStatements1($sql, $par1, $par2, $par3, $par4,$par5, $par6,$par7, $par8, $par10,$par11, $par12,$par13)
        {
            $stmt = $this->mysqli->prepare($sql);
            $stmt->bind_param("ssississsssi", $par1, $par2, $par3, $par4,$par5, $par6,$par7, $par8,  $par10,$par11, $par12,$par13); 
